...
> **注意**: 此接口已改为异步处理，提交后返回任务ID，需通过轮询 `/availability/import/status` 获取处理结果。
...
> **注意**: 此接口为异步处理，提交后返回任务ID，需通过轮询 `/availability/import/status` 获取处理结果。
...
```json
{
  "code": 200,
  "data": {
    "task_id": "task_20260329_cookie123",
    "status": "pending",
    "message": "任务已提交，请通过任务ID查询进度",
    "created_at": "2026-03-29T10:00:00Z"
  }
...
```json
{
  ...
  "data": {
    ...
    "created_at": "2026-03-29T10:00:00Z",
    "started_at": "2026-03-29T10:00:05Z",
    "completed_at": "2026-03-29T10:00:10Z",
    "result": {
      "imported": 120,
      "weeks_parsed": 20,
      "total_cells": 400,
...
```json
{
  ...
  "data": {
    ...
    "created_at": "2026-03-29T10:00:00Z",
    "started_at": "2026-03-29T10:00:05Z",
    "completed_at": "2026-03-29T10:00:06Z",
    "error": "Cookie已过期，请重新登录教务系统"
  }
}
```
