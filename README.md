...
| 📱 **移动端支持** | 完整的移动端页面，适配手机屏幕 | ✅ |
| 🤖 **安卓客户端** | 原生安卓应用，支持一键同步课表 | ✅ |
| 👥 **多部门管理** | 支持办公室、竞赛部、项目部、科普部等多个部门 | ✅ |
| 🔐 **灵活权限** | RBAC + 临时权限的混合权限模型 | ✅ |
| 📊 **每周分工** | 设置各部门本周值班日期安排 | ✅ |
| ✉️ **邮件通知** | 支持密码重置邮件发送 | ✅ |
| 📝 **权限申请** | 普通用户可申请临时权限，部门管理员审批 | ✅ |
| 📤 **排班分享** | 支持排班表一键分享至QQ群 | ✅ |
...
| 👥 部门成员 | 个人功能 + 可申请临时权限 | 普通成员 |

### 📝 临时权限申请流程

1. **普通用户** - 在「权限申请」页面提交权限申请
2. **部门管理员** - 在「待我审批」中审批申请
3. **审批通过** - 系统自动授予临时权限
4. **权限过期** - 临时权限在到期后自动失效
